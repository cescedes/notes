...
with open("passwords.csv") as password_file:
  ...
  #save each row of the csv into password_row
  #add each username to the list compromised_users
  for row in password_csv:
    password_row = row
    compromised_users.append(row)

#iterating over each compromised_users and write the username of each compromised_user in comromised_users to compromised_user_file
...
#replace passwords.csv with the following new file
